...
export function applyWordWolfStartCommand(room: Room, actorId: string, topic: WordWolfTopic, now = Date.now()) {
  ...
  return {
    ...
    topicAnchorWordMasterId: topic.anchorWordMasterId,
    topicPartnerWordMasterId: topic.partnerWordMasterId,
    topicAnchorWord: topic.anchorWord,
    topicCommonEffectiveZipf: topic.commonEffectiveZipf,
    topicWordwolfEffectiveZipf: topic.wordwolfEffectiveZipf,
    clues: [],
    votes: {},
    voteHistory: [],
