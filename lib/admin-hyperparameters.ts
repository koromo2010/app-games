  ...
  const groups: AdminHyperparameterGroup[] = [
    ...
    },
    {
      id: "nigoichi", title: gameTitle("nigoichi", "ワードアウト"), kind: "game", summary: "カード配布、連想語、余り推理、難易度、得点の調整値です。", items: [
        ...
        item("out-difficulty", "単語の難易度", "初期普通・簡単/普通/難しい", "過去指定", "部屋設定", "共通一般プールから簡単100%、普通80%＋簡単20%、難しい50%＋普通40%＋簡単10%で抽選します。", "lib/general-game-word-pool.ts"),
        ...
        item("out-pool", "単語プール", "共通DBのgeneral", "過去指定", "固定値", "有効な単語eligibilityの難易度ラベルを使います。", "lib/general-game-word-pool.ts"),
      ],
    },
    {
      id: "code-intercept", title: gameTitle("code-intercept", "コードインターセプト"), kind: "game", summary: "秘密カード、暗号桁数、ポイント、ダメージの明示指定値です。", items: [
        ...
        item("code-difficulty", "単語の難易度", "初期普通・簡単/普通/難しい", "過去指定", "部屋設定", "ワードアウトと同じ共通一般プール・混合比率を使います。", "lib/general-game-word-pool.ts"),
