  ...
  return (
    <div className="grid min-h-64 grid-cols-[4.5rem_minmax(0,1fr)] gap-3 rounded-2xl border border-white/10 bg-slate-950/55 p-4">
      <div className="relative">
        ...
        <div className="absolute bottom-6 left-9 top-6 w-2 rounded-full bg-gradient-to-b from-sky-400 via-amber-300 to-fuchsia-400 shadow-[0_0_22px_rgba(34,211,238,0.28)]">
          {markers.map((marker) => (
            <span
              key={marker.id}
              ...
              style={{ top: `${Math.max(0, Math.min(120, marker.value)) / 1.2}%` }}
