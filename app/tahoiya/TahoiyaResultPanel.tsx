...
export function TahoiyaResultPanel({ room, playerId, reasons, isHost, canReturn, isDissolved, onReturn, onDissolve }: Props) {
  ...
  return (
    <CommonGameResultShell
      ...
      utilities={feedback}
      actions={<OnlineRoomLifecycleActions surface="result" canReturnToRoom={canReturn} isHost={isHost} isRoomDissolved={isDissolved} onReturnToRoom={onReturn} onDissolve={onDissolve} />}
    >
