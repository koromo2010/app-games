...
export function TahoiyaRulesDialog({ open, onClose }: { open: boolean; onClose: () => void }) {
  return <GameRulesDialog open={open} title="たほい屋のルール" onClose={onClose}>
    ...
    <ol className="mt-2 list-decimal space-y-2 pl-5"><li>お題のことばと読み方が表示されます。</li><li>説明を書く人は、本物らしく見える偽説明を1人1つ入力します。全員が書き終わるまでは、自分の説明を直せます。</li><li>本物の説明と偽説明を、順番を混ぜて一斉に公開します。</li><li>投票する人は、本物だと思う説明を1つ選びます。全員投票モードでは、自分が書いた説明は選べません。</li><li>投票がそろうと、本物、偽説明の作者、誰がどれを選んだか、今回の得点を公開します。</li></ol>
