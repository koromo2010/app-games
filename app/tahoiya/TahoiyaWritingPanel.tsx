...
type Props = {
  ...
  submittedCount: number; writerCount: number; hasSubmitted: boolean; writingDone: boolean;
  definitionInput: string; polishMessage: string; isPolishing: boolean; isHost: boolean; isDebugMode: boolean;
  onDefinitionChange: (value: string) => void; onEditSubmitted: () => void; onPolish: () => void;
...
export function TahoiyaWritingPanel(props: Props) {
  ...
  return <div className={panelClass}>
    ...
    <p className="mt-2 text-sm text-slate-600">偽説明: {props.submittedCount}/{props.writerCount}</p>
