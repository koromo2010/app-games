...
export function SiteFooter() {
  return <footer className="border-t border-white/10 bg-slate-950 text-slate-300">
    <div className="mx-auto flex max-w-6xl flex-col gap-4 px-4 py-6 sm:flex-row sm:items-end sm:justify-between">
      <div><p className="font-black tracking-[0.16em] text-white">GAME FIELDS</p><p className="mt-1 text-xs text-slate-500">ゲームフィールド</p></div>
      ...
      <p className="text-[11px] text-slate-600">© {new Date().getFullYear()} GAME FIELDS</p>
    </div>
  </footer>;
}
