...
export function SiteAdminPanel({ showPreviewVocabularyMigrations, showReleaseManagement }: {
  showPreviewVocabularyMigrations: boolean;
  showReleaseManagement: boolean;
}) {
