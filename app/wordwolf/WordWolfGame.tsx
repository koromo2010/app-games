    ...
    <main className={`min-h-screen bg-slate-950 text-slate-950 ${gameTopBannerOffsetClass}`}>
      ...
      <GameRulesDialog open={isRulesOpen} title="ワードウルフのルール" onClose={() => setIsRulesOpen(false)}>
        ...
        <div className="mt-3 rounded-xl border border-amber-300/20 bg-amber-300/10 p-3 text-amber-100">
          ...
          <p className="mt-1">市民が狼を選び、狼の逆転回答も外れた場合は、市民全員が+1点、狼は0点です。狼が投票を逃れた場合や逆転に成功した場合は、狼全員が+1点です。</p>
        </div>
        <details className="mt-4 rounded-xl border border-white/10 bg-white/[0.04] p-3">
          ...
          <p className="mt-3 text-slate-300">10%の確率で狼がおらず、全員に同じお題が配られます。この場合は、投票で選ばれた人だけが負けて0点、ほかの全員が勝って1点です。全員が同じ票数なら、もう1周話してから再投票します。</p>
        </details>
