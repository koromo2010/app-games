...
- ニゴイチ: 言葉一覧、各プレイヤーの手札2語、連想語、余り予想、正誤
...
共有文へ説明本文、秘密語、お題の答え、参加者名、個別の投票先、認証付きプレイバックURLは原則含めない。ゲーム固有仕様で結果情報の共有を明示した場合だけ、結果画面で公開済みの内容をプレビュー付きで含められる。ニゴイチは言葉一覧、持ち主、手札2語、連想語を含めるが、参加者名は入室時の共有同意がONのときだけ表示し、それ以外は `PLAYER1` 形式で匿名化する。合言葉や認証付きURLは常に含めない。詳細本文は参加者本人がマイページで開くプレイバックだけに返す。
