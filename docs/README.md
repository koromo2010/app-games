...
2. 実装・検証・外部操作では[`DEVELOPMENT_DELIVERY_RUNBOOK.md`](./DEVELOPMENT_DELIVERY_RUNBOOK.md)、記録・引継ぎ・resultでは[`DEVELOPMENT_RECORDS_RUNBOOK.md`](./DEVELOPMENT_RECORDS_RUNBOOK.md)を読む。正本のrouterが示す該当runbookまたはreferenceだけを選び、予防的に全資料を通読しない。
...
| --- | --- | --- |
| 個別指示、実行許可、停止・終了判定 | `DEVELOPMENT_EXECUTION_RULES.md` | 最新のtask contract、該当runbook |
