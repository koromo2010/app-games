...
| Portal Vercel Project | `app-games-sdk-dev`、Root Directory `apps/sdk-portal`、Production Branch `develop`。OAuth接続、4 tool表示、`test10-1`保存と従来preview表示を実機確認済み | 本体UI共用版を反映後、`/test10-1`と`/test10-1/games/<game-id>`を実機確認 |
