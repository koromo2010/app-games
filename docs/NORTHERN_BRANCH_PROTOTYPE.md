...
ロビー上部の共通デバッグボタンから有効化します。ONのホストは最大4人までダミーユーザーを追加・個別削除でき、全員分の手札を確認しながらダミーの手番を代行できます。OFFに戻すとダミーはロビーから一括除外されます。追加・削除の認可とactive-room整理はほかのオンラインゲームと同じ共通Commandを使います。
