...
export function appendModuleUsageReview(
  ...
  const panel = `<details data-game-fields-module-usage><summary>この操作プロトタイプで使っているGame Fields機能</summary><p>profile ${escapeHtml(audit.binding.moduleProfileRevision)} / SDK ${escapeHtml(audit.binding.sdkPackageVersion)}</p><div class="game-fields-module-usage-table"><table><thead><tr><th>module・目的</th><th>提供元</th><th>状態</th><th>利用source・API</th><th>動作証拠</th></tr></thead><tbody>${rows}</tbody></table></div></details>`;
  return {
    ...files,
