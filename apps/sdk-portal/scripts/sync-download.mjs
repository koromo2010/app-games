...
const destination = resolve(appRoot, "public/GameFieldsDownloadMe-ver5.md");
...
console.log(
  `[sdk-portal] GameFieldsDownloadMe-ver5.md synced for ${sdkChannel} at ${sdkPortalBaseUrl} (platform v${release.platformVersion})`,
);
