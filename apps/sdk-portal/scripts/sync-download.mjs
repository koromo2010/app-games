...
const destination = resolve(appRoot, "public/GameFieldsDownloadMe-ver1.md");
...
console.log(
  `[sdk-portal] GameFieldsDownloadMe-ver1.md synced for ${sdkChannel} at ${sdkPortalBaseUrl} (platform v${release.platformVersion})`,
);
