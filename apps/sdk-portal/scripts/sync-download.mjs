...
const destination = resolve(appRoot, "public/GameFieldsDownloadMe.md");
...
console.log(
  `[sdk-portal] GameFieldsDownloadMe.md synced for ${sdkChannel} at ${sdkPortalBaseUrl} (platform v${release.platformVersion})`,
);
