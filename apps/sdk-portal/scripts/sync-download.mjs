...
const destination = resolve(appRoot, "public/GameFieldsDownloadMe-ver14.md");
...
console.log(
  `[sdk-portal] GameFieldsDownloadMe-ver14.md synced for ${sdkChannel} at ${sdkPortalBaseUrl} (platform v${release.platformVersion})`,
);
