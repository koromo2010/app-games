...
const destination = resolve(appRoot, "public/GameFieldsDownloadMe-ver10.md");
...
console.log(
  `[sdk-portal] GameFieldsDownloadMe-ver10.md synced for ${sdkChannel} at ${sdkPortalBaseUrl} (platform v${release.platformVersion})`,
);
