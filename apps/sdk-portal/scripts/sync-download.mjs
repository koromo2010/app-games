...
const destination = resolve(appRoot, "public/GameFieldsDownloadMe-ver9.md");
...
console.log(
  `[sdk-portal] GameFieldsDownloadMe-ver9.md synced for ${sdkChannel} at ${sdkPortalBaseUrl} (platform v${release.platformVersion})`,
);
