...
const destination = resolve(appRoot, "public/GameFieldsDownloadMe-ver15.md");
...
console.log(
  `[sdk-portal] GameFieldsDownloadMe-ver15.md synced for ${sdkChannel} at ${sdkPortalBaseUrl} (platform v${release.platformVersion})`,
);
