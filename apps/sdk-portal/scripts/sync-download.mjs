...
const destination = resolve(appRoot, "public/GameFieldsDownloadMe-ver12.md");
...
console.log(
  `[sdk-portal] GameFieldsDownloadMe-ver12.md synced for ${sdkChannel} at ${sdkPortalBaseUrl} (platform v${release.platformVersion})`,
);
