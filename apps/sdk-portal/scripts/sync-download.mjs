...
const destination = resolve(appRoot, "public/GameFieldsDownloadMe-ver6.md");
...
console.log(
  `[sdk-portal] GameFieldsDownloadMe-ver6.md synced for ${sdkChannel} at ${sdkPortalBaseUrl} (platform v${release.platformVersion})`,
);
