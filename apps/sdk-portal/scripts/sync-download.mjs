...
const destination = resolve(appRoot, "public/GameFieldsDownloadMe-ver11.md");
...
console.log(
  `[sdk-portal] GameFieldsDownloadMe-ver11.md synced for ${sdkChannel} at ${sdkPortalBaseUrl} (platform v${release.platformVersion})`,
);
