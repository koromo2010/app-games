...
const destination = resolve(appRoot, "public/GameFieldsDownloadMe-ver13.md");
...
console.log(
  `[sdk-portal] GameFieldsDownloadMe-ver13.md synced for ${sdkChannel} at ${sdkPortalBaseUrl} (platform v${release.platformVersion})`,
);
